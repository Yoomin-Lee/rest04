...
const types = [
  { key: 'general',     label: '고객 문의',  emoji: '💬' },
  { key: 'partnership', label: '제휴 문의',  emoji: '🤝' },
]
...
function ContactInfo() {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {[
        { icon: '📍', title: '주소', desc: company.offices[0].address },
        { icon: '📞', title: '전화',  desc: company.offices[0].tel },
        { icon: '✉️', title: '이메일', desc: company.offices[0].email },
      ].map(info => (
    ...
    >
      ...
      <div className="card-base overflow-hidden">
        ...
        <div className="p-6 md:p-10">
          ...
          <h2 className="mb-6 text-2xl font-extrabold text-deep dark:text-white">
